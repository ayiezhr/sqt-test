    ...
    <main>
        ...
        <div class="roomList">
            <div class="option">
                ...
                &nbsp;
                <form method="submit" action="room_add.php" id="roomAdd" name="roomAdd">
                    <input type="submit" id="add_button" name="add_button" value="Add New Room">
                </form>
            </div>
                    ...
                    if (isset($_POST['roomType'])) {
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo '<td> <a href="room_edit.php?id=' . $row["room_ID"] . '" style="background-color: #00ff00; padding: 5px 10px; text-decoration: none; border-radius: 5px; border: 1px solid #000000; color: black;">Edit</a>&nbsp;';
                                echo '<a href="room_delete.php?id=' . $row["room_ID"] . '"" style="background-color: #ff0000; padding: 5px 10px; text-decoration: none; border-radius: 5px; border: 1px solid #000000; color: black; onClick="return confirm(\'Delete?\')">Delete</a></td>';
                                echo "</tr>";
                                $numrow++;
                            }
                        } else {
